<template>
  <div class="notification_button">
    ...
    >
      <font-awesome-icon
        class="notification_button__button__icon"
        :icon="['far', 'bell']"
      />
      <span
    ...
    >
      ...
      <div class="notification_button__menu">
        ...
        >
          <div class="notification_button__menu__item__header">
            ...
            <span v-else-if="notification.type === 'reply'"
              >Reply to your post</span
            >
            <span>
              <span class="notification_button__menu__item__header__date">{{
          ...
          <div>
            ...
            wrote "{{
              notification.PostNotification.Post.content
                | stripTags
                | truncate(50)
            }}"
          </div>
        ...
        <div
          class="notification_button__menu__empty"
