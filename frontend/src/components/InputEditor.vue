<template>
  ...
  >
    <div
      ...
      :class="{ 'input_editor__overlay--show': loading }"
    >
      <loading-icon></loading-icon>
    </div>

    <div class="input_editor__reply_username" v-if="replyUsername">
      Replying to <strong>{{ replyUsername }}</strong>
    </div>
    <div
      class="input_editor__close input_editor__format_button"
      @click="closeEditor"
    >
      &times;
    </div>
