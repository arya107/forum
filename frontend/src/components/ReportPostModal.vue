  ...
  <div class="report_post_modal">
    <modal-window v-model="showModal" :loading="loading">
      <div class="report_post_modal__modal" slot="main">
        ...
        <div class="report_post_modal--margin">
          Select a reason for reporting this post below:
        </div>
        <select-button
          :options="reportOptions"
          v-model="selectedOption"
          class="report_post_modal--margin"
          :touch-disabled="true"
        ></select-button>
      </div>
      <div slot="footer">
        <button class="button button--modal" @click.stop="submitReport">
          Submit
        </button>
        <button class="button button--modal" @click.stop="setShowModal(false)">
          Cancel
        </button>
      </div>
    </modal-window>
