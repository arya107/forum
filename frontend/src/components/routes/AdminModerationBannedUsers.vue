<template>
  <div class="admin_moderation">
    <div class="admin_moderation__header">
      ...
      <button class="button button--blue" @click="toggleShowAddNewBanModal">
        Add new ban
      </button>
    </div>
    ...
    <transition name="fade" mode="out-in">
      ...
      <table class="admin_moderation__table" v-else-if="bans.length" key="bans">
        ...
        <tr :key="'ban-row-' + $index" v-for="(ban, $index) in bans">
          ...
          <td>
            <button class="button button--red" @click="deleteBan(ban, $index)">
              Delete ban
            </button>
          </td>
        </tr>
    ...
    >
      <div class="admin_moderation__add_new_ban_modal" slot="main">
        <div
          ...
          :class="{
            'admin_moderation__add_new_ban_modal__overlay--show': loading,
          }"
        >
        ...
        <p>
          Search for the user to ban, then select the relevant ban type for the
          user
        </p>
      ...
      <div slot="footer">
        <button class="button button--modal button--green" @click="addBan">
          Add ban
        </button>
        <button class="button button--modal" @click="toggleShowAddNewBanModal">
          Cancel
        </button>
      </div>
    </modal-window>
