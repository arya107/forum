  ...
  <div class="route_container user_route">
    <div class="user_header">
      ...
      <div class="user_header__info">
        ...
        <span class="user_header__date" v-if="user"
          >User since {{ user.createdAt | formatDate("date") }}</span
        >
        <div
          class="user_description"
          v-if="user && user.description && user.description.length"
...
.user_header {
  ...
  @at-root #{&}__icon {
    ...
    width: 6rem;
    line-height: 5.5rem;
    @include text($font--role-emphasis, 5rem) text-align: center;
