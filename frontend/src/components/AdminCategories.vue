<template>
  <div class="admin_categories">
    <modal-window v-model="showAddModal" :loading="loading">
      ...
      <div slot="footer">
        <button class="button button--modal button--green" @click="addCategory">
          Add category
        </button>
        <button class="button button--modal" @click="toggleAddModal">
          Cancel
        </button>
      </div>
    </modal-window>
    ...
    <modal-window v-model="showEditModal" :loading="loading">
      ...
      <div slot="footer">
        ...
        <button class="button button--modal" @click="toggleEditModal(null)">
          Cancel
        </button>
      </div>
    </modal-window>
    ...
    <div class="category_widget__box">
      ...
      <transition-group name="slide">
        ...
        >
          ...
          ></div>
          <div class="admin_categories__category__name">
            {{ category.name }}
          </div>
        </div>
      </transition-group>
      <div style="margin-top: 0.5rem">
        <div
          class="admin_categories__category admin_categories__category--add"
