<template>
  <div class="widgets__categories_chart" ref="container">
    <div
      class="widgets__categories_chart__overlay"
      :class="{ 'widgets__categories_chart__overlay--show': loading }"
    >
    ...
    <div class="widgets__categories_chart__main">
      <svg>
        <g ref="g"></g>
        <text
          class="widgets__categories_chart__empty"
          x="50%"
          y="53%"
          v-if="!anyThreadsExist"
        >
          No threads yet
        </text>
      </svg>
      <div class="widgets__categories_chart__main__legend">
        ...
        >
          <div
            class="widgets__categories_chart__label__square"
