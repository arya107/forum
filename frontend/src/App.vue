  ...
  <div id="app">
    ...
    >
      <div slot="main">
        <p
          :key="error"
          v-for="error in this.$store.state.ajaxErrors"
          style="margin: 1rem;"
        >
          {{ error }}
        </p>
      ...
      >
        <template slot="Sign up">
          <p style="margin-top: 0;" v-if="$store.state.token">
            <strong
              >Providing the token is still valid, this will create an admin
              account</strong
            >
          </p>
    ...
    <header class="header">
      ...
      <div class="header__group" :class="{ 'header__group--show': showMenu }">
        ...
        <template v-else>
          <div
            class="button button--green button--thin_text"
            @click="showAccountModalTab(0)"
          >
            Sign up
          </div>
      ...
      <div
        ...
        :class="{ 'header__overlay--show': showMenu }"
        @click="toggleMenu"
      ></div>
        ...
        this.axios
          ...
          .catch(e => {
            ...
            this.ajaxErrorHandler(e, error => {
              ...
              if (
                this.signup.errors[path] !== undefined &&
                this.signup.errors[path] !== undefined
              ) {
  ...
  created() {
    ...
    this.axios
      ...
      .then(res => {
        ...
        if (
          !this.$store.state.meta.title.length &&
